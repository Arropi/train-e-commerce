export default function FooterComponent() {
  return (
    <footer
      className="relative bg-cover bg-center bg-no-repeat text-white px-6 pt-8 pb-12"
      style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg">Sekolah Vokasi</p>
              <p className="text-lg">Universitas Gadjah Mada</p>
              <p className="text-lg">
          ...
          <div className="space-y-4 md:pl-50 mt-8">
