...
export default function Hero({ session }: { session: Session }) {
  const [activeCard, setActiveCard] = useState(0); // Card pertama aktif by default

  const topCards = [
    { id: 0, title: "Laboratorium Elektronika", iconPath: "/icons/logo elektronika.svg", labPath: "/lab/1" },
    { id: 1, title: "Laboratorium IDK", iconPath: "/icons/lab_idk.svg", labPath: "/lab/2" },
    { id: 2, title: "Laboratorium TAJ", iconPath: "/icons/lab_taj.svg", labPath: "/lab/3" },
    { id: 3, title: "Laboratorium RPL", iconPath: "/icons/lab_rpl.svg", labPath: "/lab/4" },
    { id: 4, title: "Laboratorium TL", iconPath: "/icons/lab_tl.svg", labPath: "/lab/5" },
  ];
