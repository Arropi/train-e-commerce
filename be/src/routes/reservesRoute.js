...
const { createReservesUser, getReservesUser, updateReserveUser, getReservesInUse, getReservesLaboratoryInUse, getReservesAdmin } = require('../controller/reservesController')
